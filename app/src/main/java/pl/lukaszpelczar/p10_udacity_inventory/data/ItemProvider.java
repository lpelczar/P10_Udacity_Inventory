...
public class ItemProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://pl.lukaszpelczar.p10_udacity_inventory/items" will
        // map to the integer code {@link #ITEMS}. This URI is used to provide access to MULTIPLE rows
        // of the items table.
        sUriMatcher.addURI(ItemContract.CONTENT_AUTHORITY, ItemContract.PATH_ITEMS, ITEMS);

        // The content URI of the form "content://pl.lukaszpelczar.p10_udacity_inventory/items/#"
        // will map to the integer code {@link #ITEM_ID}. This URI is used to provide access to ONE
        // single row of the items table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://pl.lukaszpelczar.p10_udacity_inventory/items/3" matches, but
        // "content://pl.lukaszpelczar.p10_udacity_inventory/items" (without a number at the end)
        // doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://pl.lukaszpelczar.p10_udacity_inventory/3",
